...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="pt-24">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                <p class="uppercase tracking-loose w-full">Welcome to a World of Perspectives!</p>
                <h1 class="my-4 text-4xl font-bold leading-tight">
                    Embrace Diversity: Explore the World Through International Blogs.
                </h1>
                <p class="leading-normal text-2xl mb-8">
                    Discover Global Stories, Welcome!
                </p>
                <a href="{{ route('guestarticles') }}"
                    class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Disvover new articles
                </a>
            </div>
            <!--Right Col-->
            <div class="w-full md:w-2/5 py-5 text-center md:ml-8 lg:ml-12 ">
                <img src="{{ asset('images/mainimg.png') }}" alt="mainimg" class=" rounded-full ml-10">
            </div>
        </div>
    </div>
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                        Explore Diverse Topics: Engaging Blogs Await!
                    </h3>
                    <p class="text-gray-600 mb-8">
                        Discover a variety of topics on our website's blogs. From tech to travel, fashion to food, find
                        fresh perspectives and engaging content that resonates with you. Explore the world of ideas and
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                            Global Voices: Connecting Cultures Through Shared Stories
                        </h3>
                        <p class="text-gray-600 mb-8">
                            Our authors hail from every corner of the world, offering a rich mosaic of perspectives and
                            experiences. From bustling cities to remote villages, our global community shares a passion
                            for sharing knowledge and stories. Together, we celebrate diversity and curiosity,
                            connecting users worldwide in a shared journey of discovery. </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                ...
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Discover a diverse collection of blogs from around the world. Explore different topics,
                            cultures, and perspectives—all in one place! </p>
                    </a>
                </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        <div class="w-full font-bold text-xl text-gray-800 px-6">
                            Exlore Our Featured Blogs.
                        </div>
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Dive into captivating stories from our global contributors. From travel adventures to tech
                            insights, there's something for everyone! </p>
                    </a>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p class="text-gray-800 text-base px-6 mb-5">
                            Ready to expand your horizons? Join our growing community of readers and writers. Start
                            exploring now! </p>
                    </a>
                </div>
                <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <h3 class="my-4 text-3xl leading-tight">
            Unlock a World of Possibilities: Your Journey Begins Here!
        </h3>
        <br>
